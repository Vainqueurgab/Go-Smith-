...
module.exports = {
  ...
  langs: {
    ...
    en: {
      help: "◕𝗔𝗫𝗘𝗟 𝗦𝗠𝗜𝗧𝗛◕✖\n %1 ●══════❍══════●\n 🎯𝐩𝐚𝐠𝐞 [%2/%3] \n🎯➳𝐋𝐞 𝐛𝐨𝐭 𝐝𝐢𝐬𝐩𝐨𝐬𝐞 𝐝𝐞 %4 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐞  \n 🎯➳ 𝐏𝐨𝐮𝐫 𝐜𝐨𝐧𝐬𝐮𝐥𝐭𝐞𝐫 𝐥𝐚 𝐥𝐢𝐬𝐭𝐞 𝐜𝐨𝐦𝐩𝐥è𝐭𝐞 𝐝𝐞𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐞 ,𝐯𝐞𝐮𝐢𝐥𝐥𝐞𝐳 𝐭𝐚𝐩𝐞𝐫~𝐡𝐞𝐥𝐩 <𝐩𝐚𝐠𝐞> \n 🎯➳ 𝐀𝐯𝐞𝐜 𝐥𝐚 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐞 ~𝐬𝐨𝐫𝐭𝐡𝐞𝐥𝐩 𝐜𝐚𝐭𝐞𝐠𝐨𝐫𝐲 𝐭𝐮 𝐩𝐞𝐮𝐱 𝐯𝐨𝐢𝐫 𝐭𝐨𝐮𝐭𝐞 𝐥𝐞𝐬 𝐜𝐦𝐦𝐚𝐧𝐝𝐞𝐬 𝐝'𝐮𝐧 𝐬𝐞𝐮𝐥 𝐜𝐨𝐮𝐩. \n🎯➳👋 𝐒𝐚𝐥𝐮𝐭 𝐚 𝐭𝐨𝐢 , 𝐜𝐡𝐞𝐫𝐜𝐡𝐞𝐮𝐫 𝐝𝐞 𝐛𝐨𝐧𝐡𝐞𝐮𝐫 ! 𝐄𝐧 𝐮𝐭𝐢𝐥𝐢𝐬𝐚𝐧𝐭 𝐥𝐚 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐞 :~Gloriagc, 𝐨𝐮𝐯𝐫𝐞 𝐥𝐞𝐬 𝐩𝐨𝐫𝐭𝐞𝐬 𝐝'𝐮𝐧𝐞 𝐣𝐨𝐲𝐞𝐮𝐬𝐞 𝐜𝐨𝐦𝐦𝐮𝐧𝐚𝐮𝐭é🌹 𝐨ù 𝐫è𝐠𝐧𝐞 𝐥𝐞𝐬 é𝐜𝐥𝐚𝐭𝐬 𝐝𝐞 𝐫𝐢𝐫𝐞 𝐞𝐭 𝐝𝐞𝐬 𝐝𝐢𝐬𝐜𝐮𝐬𝐬𝐢𝐨𝐧𝐬 𝐞𝐩𝐚𝐧𝐨𝐮𝐢𝐬𝐬𝐚𝐧𝐭𝐞𝐬✨ . 𝐑𝐞𝐣𝐨𝐢𝐧𝐬-𝐧𝐨𝐮𝐬 𝐩𝐨𝐮𝐫 𝐩𝐚𝐫𝐭𝐚𝐠𝐞𝐫 𝐝𝐞𝐬 𝐦𝐨𝐦𝐞𝐧𝐭𝐬 𝐫𝐞𝐦𝐩𝐥𝐢𝐬 𝐝𝐞 𝐜𝐡𝐚𝐥𝐞𝐮𝐫 𝐞𝐭 𝐝'𝐚𝐦𝐢𝐭𝐢é 🥳🌺●══════❍\n🎀𝗯𝗼𝘁 𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 𝗯𝘆 𝗼𝗹𝗶𝘃𝗲𝗿 𝗴𝗮𝗯𝗿𝗶𝗲𝗹.",
      help2: "◕𝗔𝗫𝗘𝗟 𝗦𝗠𝗜𝗧𝗛◕✖\n %1 ●══════❍══════●\n 🎯➳𝐋𝐞 𝐛𝐨𝐭 𝐝𝐢𝐬𝐩𝐨𝐬𝐞 𝐝𝐞 %4 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐞 \n 🎯➳👋 𝐒𝐚𝐥𝐮𝐭 𝐚 𝐭𝐨𝐢 , 𝐜𝐡𝐞𝐫𝐜𝐡𝐞𝐮𝐫 𝐝𝐞 𝐛𝐨𝐧𝐡𝐞𝐮𝐫 ! 𝐄𝐧 𝐮𝐭𝐢𝐥𝐢𝐬𝐚𝐧𝐭 𝐥𝐚 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐞 : ~Olivergc 𝗼⃪𝘂⃪ ~Gabrielgc , 𝐨𝐮𝐯𝐫𝐞 𝐥𝐞𝐬 𝐩𝐨𝐫𝐭𝐞𝐬 𝐝'𝐮𝐧𝐞 𝐣𝐨𝐲𝐞𝐮𝐬𝐞 𝐜𝐨𝐦𝐦𝐮𝐧𝐚𝐮𝐭é🌹 𝐨ù 𝐫è𝐠𝐧𝐞 𝐥𝐞𝐬 é𝐜𝐥𝐚𝐭𝐬 𝐝𝐞 𝐫𝐢𝐫𝐞 𝐞𝐭 𝐝𝐞𝐬 𝐝𝐢𝐬𝐜𝐮𝐬𝐬𝐢𝐨𝐧𝐬 𝐞𝐩𝐚𝐧𝐨𝐮𝐢𝐬𝐬𝐚𝐧𝐭𝐞𝐬✨ . 𝐑𝐞𝐣𝐨𝐢𝐧𝐬-𝐧𝐨𝐮𝐬 𝐩𝐨𝐮𝐫 𝐩𝐚𝐫𝐭𝐚𝐠𝐞𝐫 𝐝𝐞𝐬 𝐦𝐨𝐦𝐞𝐧𝐭𝐬 𝐫𝐞𝐦𝐩𝐥𝐢𝐬 𝐝𝐞 𝐜𝐡𝐚𝐥𝐞𝐮𝐫 𝐞𝐭 𝐝'𝐚𝐦𝐢𝐭𝐢é 🥳🌺",
